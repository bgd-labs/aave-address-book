export const STATIC_A_TOKEN_FACTORY_ABI = [
  {
    inputs: [
      ...
      {internalType: 'address', name: 'staticATokenImpl', type: 'address'},
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: true, internalType: 'address', name: 'staticAToken', type: 'address'},
  ...
  {
    inputs: [{internalType: 'address[]', name: 'underlyings', type: 'address[]'}],
