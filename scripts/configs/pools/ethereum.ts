...
export const mainnetProtoV3Pool: PoolConfig = {
  ...
  additionalAddresses: {
    ...
    CONFIG_ENGINE: '0x19A109d0dCB1268729341732Ac146D4A74c7034f',
...
export const lidoEthereumMainnetProtoV3Pool: PoolConfig = {
  ...
  additionalAddresses: {
    ...
    CONFIG_ENGINE: '0xAB8EbcFaF43340b0003596f6D016964177C294C0',
...
export const etherFiEthereumMainnetProtoV3Pool: PoolConfig = {
  ...
  additionalAddresses: {
    ...
    CONFIG_ENGINE: '0xfa4B5444cbB90f19f1C28FcE63924013C84140D9',
