...
export const ethereumAddresses: NetworkAddresses<{
  ...
  ROCKET_NETWORK_BALANCES: Hex;
  STADER_LABS_ORACLE: Hex;
  CBETH_ORACLE: Hex;
  ETHERFI_LIQUIDITY_POOL: Hex;
}> = {
  name: 'Ethereum',
  ...
  addresses: {
    ...
    ROCKET_NETWORK_BALANCES: '0x6Cc65bF618F55ce2433f9D8d827Fc44117D81399',
    STADER_LABS_ORACLE: '0xF64bAe65f6f2a5277571143A24FaaFDFC0C2a737',
    CBETH_ORACLE: '0x9b37180d847B27ADC13C2277299045C1237Ae281',
