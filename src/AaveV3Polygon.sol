...
library AaveV3PolygonEModes {
  ...
  uint8 internal constant DAI_USDC_USDT0_EURS_JEUR_EURA_MIMATIC_USDCN_ = 1;

  uint8 internal constant WPOL_STMATIC_MATICX_WPOL = 2;

  uint8 internal constant WETH_WSTETH_WETH = 3;
}
