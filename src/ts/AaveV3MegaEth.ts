...
export const POOL_IMPL = '0xc74c6a98593214934e6F9C88C43c3A696C44da4D';
...
export const CONFIG_ENGINE = '0xA25d9f14CFA40d3227ED9a48B124667dDFfCFdDD';
...
export const RISK_COUNCIL = '0x36CF7a4377aAf1988E01a4b38224FC8D583E50A9';
...
export const ASSETS = {
  WETH: {
    ...
    STATA_TOKEN: '0x72E831E28Ba5A6d55Eb752981D0426b411E4dbbF',
  },
  BTCb: {
    decimals: 8,
    id: 1,
    ...
    STATA_TOKEN: '0x3FBe2d59F93AD0e54077861E810B2868c544C333',
  },
  USDT0: {
    decimals: 6,
    id: 2,
    ...
    STATA_TOKEN: '0x31552822e76a991CEB44dE047A26441E530D6510',
  },
  USDm: {
    decimals: 18,
    id: 3,
    ...
    STATA_TOKEN: '0x0a21f20c528B54Ab54573A21f948B242d19E3ef1',
  },
  wstETH: {
    decimals: 18,
    id: 4,
    ...
    STATA_TOKEN: '0x03A53f1FABC40D548198ECd79997600982B0a36E',
  },
  wrsETH: {
    decimals: 18,
    id: 5,
  ...
  USDe: {
    ...
    A_TOKEN: '0x78f2cB75D664d6f71433174056c25A5958B4016F',
    V_TOKEN: '0x7dD785D88A64dd7db6b46DaD4d2e0728CC65e009',
    INTEREST_RATE_STRATEGY: '0x5cC4f782cFe249286476A7eFfD9D7bd215768194',
    ORACLE: '0x6B00ffb3852E87c13b7f56660a7dfF64191180B3',
    STATA_TOKEN: '0xB955033Afc19816e83655C28461574D77b3097bb',
  },
  stcUSD: {
    decimals: 18,
    id: 8,
    UNDERLYING: '0x88887bE419578051FF9F4eb6C858A951921D8888',
    A_TOKEN: '0xB1B4B54780fDf4FFa82c9C1e83BEc12c63BC8eBB',
    V_TOKEN: '0x9c9a07734F7a2A1467C4eE577E652F9a14E2bB72',
    INTEREST_RATE_STRATEGY: '0x5cC4f782cFe249286476A7eFfD9D7bd215768194',
...
export const E_MODES = {
  ...
  '5': {
    ...
    borrowableAssets: ['0x4200000000000000000000000000000000000006'],
    ltvzeroBitmap: '32',
    ltvzeroAssets: ['0x4Fc44BE15e9B6E30C1E774E2C87A21D3E8b5403F'],
    ltv: 9300,
  ...
  '8': {
    label: 'stcUSD / USDT0,USDm',
    collateralBitmap: '256',
    collateralAssets: ['0x88887bE419578051FF9F4eb6C858A951921D8888'],
    borrowableBitmap: '12',
    borrowableAssets: [
      '0xB8CE59FC3717ada4C02eaDF9682A9e934F625ebb',
      '0xFAfDdbb3FC7688494971a79cc65DCa3EF82079E7',
