...
contract AaveAddressBookTest is Test {
    ...
    function testFailPoolAddressProviderIs0Address() public {
        assertEq(address(AaveV3FantomTestnet.POOL_ADDRESSES_PROVIDER), address(0));
    }

    function testFailPoolAddressIs0Address() public {
        assertEq(address(AaveV3FantomTestnet.POOL), address(0));
    }

    function testFailPoolConfiguratorIs0Address() public {
        assertEq(address(AaveV3FantomTestnet.POOL_CONFIGURATOR), address(0));
    }
