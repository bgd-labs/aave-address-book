      ...
      <span className="absolute left-0 top-0 h-full w-full">
        <span
          className={cn(
            "will-change[transform] ease-cubic-bezier[.3,.7,.4,1] absolute bottom-0 left-0 h-full w-2 origin-left -translate-x-2 translate-y-2 skew-y-[-45deg] border border-b-0 border-r-0 border-brand-900 bg-brand-500 transition-transform group-last/box:border-b",
            {
              ...
              ["group-hover/box:scale-x-150 group-hover/box:border-l-[0.5px] group-active/box:scale-100 group-active/box:border-l"]:
                isHoverable,
            },
          )}
        />
        <span
          className={cn(
            ...
            {
              ["group-hover/box:scale-y-150 group-hover/box:border-b-[0.5px] group-hover/box:border-l group-hover/box:border-t-[0.5px] group-hover/box:bg-brand-300 group-last/box:group-hover/box:border-l-0 group-last/box:group-hover/box:border-t-0 group-active/box:scale-100 group-active/box:border-b"]:
                isHoverable,
            },
          )}
        />
      ...
      <span
        className={cn(
          ...
          className,
          {
            ...
            ["group-hover/box:-translate-y-1 group-hover/box:translate-x-1 group-hover/box:border-brand-900 group-active/box:translate-x-0 group-active/box:translate-y-0"]:
              isHoverable,
          },
        )}
      >
